...
TOOL_SCHEMAS = [
    _tool("list_design_tokens", "Return the Bank design tokens (color/type/space) and component index."),
    ...
    _tool("get_brand_guideline", "Return Bank brand palette, font, and draft-generation rules."),
